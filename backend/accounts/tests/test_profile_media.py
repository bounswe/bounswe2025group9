    ...
    def test_upload_profile_image_png(self):
        ...
        with open(file.name, "rb") as img:
            uploaded_file = SimpleUploadedFile(
                "test.png", img.read(), content_type="image/png"
            )
...
class UpdateUserTests(APITestCase):
    ...
    def test_update_user_success(self):
        ...
        data = {"email": "newemail@example.com", "address": "New Address"}
    ...
    def test_update_user_email_only(self):
        ...
        data = {"email": "updated@example.com", "address": "Old Address"}
        response = self.client.post(self.update_url, data)
    ...
    def test_update_user_address_only(self):
        ...
        data = {"email": "test@example.com", "address": "Brand New Address"}
        response = self.client.post(self.update_url, data)
    ...
    def test_update_user_no_auth(self):
        ...
        data = {"email": "new@example.com", "address": "New Address"}
        response = self.client.post(self.update_url, data)
    ...
    def test_update_user_invalid_email(self):
        ...
        data = {"email": "not-an-email", "address": "New Address"}
        response = self.client.post(self.update_url, data)
